    ...
    <>
      <DialogLayout highlight={Highlight()}>
        <Card title="Venha fazer parte!" className="max-w-lg gap-2">
          ...
          <Anchor to="/login">Ja possui conta? Faça login</Anchor>
        </Card>
      </DialogLayout>
    </>
  );
  ...
  return (
    <div className="flex h-full w-3/5 flex-col justify-center gap-2 pl-8 text-gray-900">
      ...
      <p className="text-lg font-medium">
        Descubra, liste, avalie, comente, compartilhe, faça amigos e participe de clubes de seus
        filmes e séries favoritos! O Popcorn Club é um espaço de conexão e interação sobre seu
        entretenimento favorito.
      </p>
    </div>
  );
}
