...
function getLabel(label: React.ReactNode | string | undefined): React.ReactNode {
...
function getIcon(icon: React.ReactNode | IconType | undefined): React.ReactNode {
...
function getType(type: React.ReactNode | InputType | undefined): React.ReactNode {
  if (!type) {
    return <InputText />;
  }
...
function getHint(hint: React.ReactNode | string | undefined, state: InputState): React.ReactNode {
