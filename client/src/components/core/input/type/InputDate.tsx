...
export function InputDate(props: InputHTMLAttributes<HTMLInputElement>): React.ReactNode {
  ...
  const handleClick = (e: React.MouseEvent<HTMLInputElement, MouseEvent>): void => {
  ...
  return (
    <div className="relative flex w-full flex-col">
      <input
        ...
        onClick={handleClick}
        value={typeof value.current === "string" ? value.current : value.current.toLocaleDateString()}
        {...registerProps}
        {...rest}
      />
      {pickerVisible && (
        <Datepicker
          ...
          defaultDate={typeof value.current === "string" ? undefined : value.current}
  ...
  popup: {
    ...
    footer: {
      ...
      button: {
        ...
        today: "bg-sky-500 text-white hover:bg-sky-600 dark:bg-sky-600 dark:hover:bg-sky-700",
        clear:
